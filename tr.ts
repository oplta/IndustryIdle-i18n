export const TR = {
    ...
    Actions: "Hareketler",
    FuelType: "Yakıt Seç",
    FuelCost: "Yakıt Fiyatı",
    FuelConsumption: "%{fuel} Tüketim",
    FuelEconomy: "Yakıt Ekonomisi",
    FuelProduction: "%{fuel} Üretimi",
    FuelInStorage: "%{fuel} Miktarı",
    Plastic: "Pilastik",
    FuelSurplus: "%{fuel} Fazlası",
    Petrol: "Petrol",
    Buy: "Satın Al",
    NoLiquidity: "Nakit Yok",
    NoLiquidityTurnOffAutoSell: "%{res} için yeterli nakitin yok, otomatik satış kapatıldı",
    Multiplier: "Multiplier",
    MultiplierDesc: "Her 10 levelde +1 çarpan kazanırsın",
    SellBuilding: "Binayı Sat",
    PowerGrid: "Güç Izgarası",
    TradeAmount: "Ticaret Tutarı",
    SortBy: "Göre Sırala",
    SortByPrice: "Fiyat",
    SortByAmount: "Tutar",
    NotEnoughResourcesForTrade: "Ticaret Merkezinde bu ticaret için yeterli kaynak(lar) yok",
    ...
    Unlock: "Kilidi aç",
    BuildingUnlocked: "%{building} kilidi açıldı",
    Science: "Bilim",
    ScienceFromPowerDesc: "Enerji santralleri, enerji üretirken az miktarda Bilim üretir",
    Culture: "Kültür",
    School: "Okul",
    University: "Üniversite",
    Polytechnic: "Politeknik",
    Colosseum: "Kolezyum",
    WindTurbine: "Rüzgar Gülü",
    Engine: "Motor",
    ...
    MinimumTradingAmount: "Minimum tutardan daha düşük işlem yapamazsınız",
    ...
    BuildingPermitDesc:
        "%{amount} bina için izniniz var, zaten %{amountBuilt} yaptınız ve %{amountLeft} kaldı",
    BuildingLocked: "Bina henüz mevcut değil, önce Araştırma Laboratuvarı'nda açmanız gerekiyor",
